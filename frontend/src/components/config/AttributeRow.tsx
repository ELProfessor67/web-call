    ...
    <div className="flex flex-col mb-2">
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 min-w-0 text-gray-600 text-sm bg-transparent border border-gray-800 rounded-sm px-3 py-1 font-mono"
          placeholder="Value"
          disabled={disabled}
        />
        {onRemove && (
          <button
            ...
            className="flex-shrink-0 w-6 h-6 flex items-center justify-center text-gray-600 hover:text-gray-900"
            disabled={disabled}
