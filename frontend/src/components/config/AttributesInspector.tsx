...
export const AttributesInspector: React.FC<AttributesInspectorProps> = ({
  ...
  return (
    <div>
      ...
      {isExpanded && (
        <div className="border border-gray-800 rounded-sm bg-gray-100/30 p-3 mb-2">
          {disabled ? (
            ...
            <>
              ...
              <div className="flex justify-between items-center">
                ...
                {showSyncFlash && (
                  <div className="text-xs text-gray-600 animate-fade-in-out">
                    Changes saved
                  </div>
                )}
              </div>
      ...
      <>
        ...
        {isMetadataExpanded &&
          (disabled || connectionState === ConnectionState.Connected ? (
            <div className="border border-gray-800 rounded-sm bg-gray-100/30 px-3 py-2 mb-4 min-h-[40px] flex items-center">
              {metadata ? (
                <pre className="w-full text-gray-600 text-xs bg-transparent font-mono whitespace-pre-wrap break-words m-0 p-0 border-0">
                  {metadata}
                </pre>
              ) : (
                <div className="text-sm text-gray-600 font-sans w-full text-left">
                  No metadata set
                </div>
              )}
            </div>
            ...
            <textarea
              ...
              className="w-full text-gray-600 text-sm bg-transparent border border-gray-800 rounded-sm px-3 py-2 font-mono mb-4"
