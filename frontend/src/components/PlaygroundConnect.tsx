...
const ConnectTab = ({ active, onClick, children }: any) => {
  ...
  if (active) {
    className += " border-b border-orange-500 text-orange-500";
  } else {
...
const TokenConnect = ({
  ...
  return (
    <div className="flex left-0 top-0 w-full h-full bg-white/80 items-center justify-center text-center">
      <div className="flex flex-col gap-4 p-8 bg-gray-50 w-full text-gray-900 border-t border-gray-900">
        <div className="flex flex-col gap-2">
          <input
            value={url}
            onChange={(e) => setUrl(e.target.value)}
            className="text-gray-900 text-sm bg-transparent border border-gray-800 rounded-sm px-3 py-2"
            placeholder="wss://url"
          ></input>
          <textarea
            value={token}
  ...
  return (
    <div className="flex left-0 top-0 w-full h-full bg-white/80 items-center justify-center text-center gap-2">
      <div className="min-h-[540px]">
        <div className="flex flex-col bg-gray-50 w-full max-w-[480px] rounded-lg text-gray-900 border border-gray-900">
          <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col bg-gray-100/30 flex-grow">
