...
export const PlaygroundDeviceSelector = ({
  ...
  return (
    <div>
      <button
        className="flex gap-2 items-center px-2 py-1 bg-gray-100 text-gray-700 border border-gray-800 rounded-sm hover:bg-gray-200"
        onClick={(e) => {
      ...
      <div
        className="absolute right-4 top-12 bg-gray-200 text-gray-700 border border-gray-800 rounded-sm z-10"
        style={{
            ...
            <div
              ...
              className={`${
                device.deviceId === deviceSelect.activeDeviceId
                  ? "text-gray-900"
                  : "text-gray-500"
              } bg-gray-100 text-xs py-2 px-2 cursor-pointer hover:bg-gray-200 hover:text-gray-900`}
              key={index}
            >
              {device.label}
            </div>
